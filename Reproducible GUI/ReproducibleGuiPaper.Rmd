...
<!-- SENTENCE EXPLAINING WHAT IS GUI. VERSIONS AMF. PRIVACY. GUI data can be obtained -->
<!-- from WHERE. -->
...
<!-- WHAT MAKES GUI DIFFERENT FROM OTHER SOCIAL SCIENCE DATASETS. WHY IS THIS ARTICLE USEFUL?  -->
